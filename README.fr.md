...
1. Téléchargez `OkTally-0.8.0.dmg` depuis la [page Releases](https://github.com/OkamiOps/OkTally/releases).
...
Nécessite les Xcode Command Line Tools avec Swift 5.9+.
